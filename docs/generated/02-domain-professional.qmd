...
### The keyword-framed question result
...
### The command result and internal match coordinates
...
```{.swift .numberLines startFrom="66"}
...
```{.swift .numberLines startFrom="204"}
...
### Detecting a keyword-framed model question
...
```{.swift .numberLines startFrom="251"}
...
```{.swift .numberLines startFrom="399"}
...
```{.swift .numberLines startFrom="416"}
...
```{.swift .numberLines startFrom="441"}
...
### Normalized words and cleaning punctuation left by command removal
...
```{.swift .numberLines startFrom="468"}
